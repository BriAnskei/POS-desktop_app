...
public class NewDeliveryController {
	...
	private Delivery buildDeliveryFromState() {
		...
		// Note: ID is null for new delivery, will be generated by database
		Delivery delivery = new Delivery(scheduleDate, deliveryName, expenses, totalGross, totalCapital, grossProfit,
				netProfit);
