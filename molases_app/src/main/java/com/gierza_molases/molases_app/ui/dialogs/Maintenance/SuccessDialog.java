...
public class SuccessDialog extends JDialog {
	...
	public SuccessDialog(Window parent, int deletedCount) {
		super(parent, "Deletion Complete", ModalityType.APPLICATION_MODAL);
		initializeUI(deletedCount);
		setLocationRelativeTo(parent);
	}

	private void initializeUI(int deletedCount) {
		...
		JLabel titleLabel = new JLabel("✅  Deletion Complete");
		...
		JLabel countLabel = new JLabel("<html><div style='text-align: center;'>Successfully deleted <b>" + deletedCount
				+ " deliveries</b><br>and all related records.</div></html>");
		...
		JLabel infoLabel = new JLabel("Your database has been cleaned.");
		...
		JButton closeButton = createStyledButton("Close", SUCCESS_GREEN, Color.WHITE);
